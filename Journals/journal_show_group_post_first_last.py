# Simcenter 3D 2306
# Journal created by HP on Tue Jul 23 09:07:15 2024 W. Europe Daylight Time
#
import math
import NXOpen
import NXOpen.CAE
def main() : 
    ...
    usergroupIds2[0] = 107
    theSession.Post.PostviewApplyUserGroupVisibility(1, results2, usergroupIds2, NXOpen.CAE.Post.GroupVisibility.ShowOnly)
